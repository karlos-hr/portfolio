...
export const workExperiences : IWorkExperience[] = [
    {
        ...
        description: [
            ...
            "Implement data storage solutions using databases like MySQL, SQL Server and SQLite",
            "Develop user-facing features using front-end technologies such as Angular (HTML, CSS and Typescript)."
        ],
        date: "2023 - 2024",
        time: "1 year",
        site: "Granada, España."
    },
    {
        ...
        description: [
            ...
            "Support the implementation of UI/UX designs provided by the design team."
        ],
        date: "2023",
        time: "6 months",
        site: "Granada, España."
